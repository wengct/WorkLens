...
| 檔案 | 來源與授權 |
| --- | --- |
| `git.svg` | [Git 官方圖示](https://git-scm.com/images/logos/downloads/Git-Icon-1788C.svg)，Git Logo by Jason Long，依 [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/) 使用。圖形及配色未修改。 |
| `azure-devops.svg` | [Devicon 原始檔](https://github.com/devicons/devicon/blob/7330accdbc47e2dc0c19789a48533c4a3c50fe58/icons/azuredevops/azuredevops-original.svg)，MIT 授權全文見 `DEVICON-LICENSE`。 |
