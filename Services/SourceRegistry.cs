        ...
        adapters
            .Select(x => new SourceDefinition(
                ...
                x.Key switch
                {
                    ...
                    ActivitySourceType.AzureDevOpsPullRequest => "Azure DevOps",
                    ActivitySourceType.WindowsClaudeCode => "Windows Claude Code",
                    ActivitySourceType.WindowsAntigravityCli => "Windows Antigravity CLI",
                    ActivitySourceType.WslClaudeCode => "WSL Claude Code",
                    ActivitySourceType.WslAntigravityCli => "WSL Antigravity CLI",
                    ActivitySourceType.MacOsClaudeCode => "macOS Claude Code",
                    ActivitySourceType.MacOsAntigravityCli => "macOS Antigravity CLI",
